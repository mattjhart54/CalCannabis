...
//		runReportAttach(capId,"Scientific Review Checklist","altId",licAltId);
	...
	logDebug("Science Checklist ran for " + licAltId);	
...
//Send Notification for NSF Payment
	...
	if (dishonoredPayment){
		email("michael@reed-consults.com", "noreply@cannabis.ca.gov", "Dishonored Payment Fee paid on " + capId.getCustomID(), "This serves as notice that a payment has been made on record " + capId.getCustomID() + " that includes a dishonored payment fee.") 
	}
