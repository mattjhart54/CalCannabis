/*------------------------------------------------------------------------------------------------------/
| Program : ACA_BEFORE_CRR_VALIDATE_PREMISES_ADDRESSES.js
...
try {
	...
	logDebug("A JavaScript Error occurred:ACA_BEFORE_CRR_VALIDATE_PREMISES_ADDRESSES: " + err.message);
	logDebug(err.stack);
	aa.sendMail(sysFromEmail, debugEmail, "", "A JavaScript Error occurred: ACA_BEFORE_CRR_VALIDATE_PREMISES_ADDRESSES: " + startDate, "capId: " + capId + br + err.message + br + err.stack + br + currEnv);
}
