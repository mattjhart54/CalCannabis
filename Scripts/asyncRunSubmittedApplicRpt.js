...
//----------------------- 
	...
	aa.print(err.stack);
	aa.sendMail("noreply@cannabis.ca.gov", "lwacht@trustvip.com", "", "AN ERROR HAS OCCURRED IN asyncRunSubmittedApplicRpt: ",  tmpID + br +"elapsed time: " + eTime + " seconds. " + br + "altId: " + sendCap + br + "avpre6" + br + eTxt);
}
