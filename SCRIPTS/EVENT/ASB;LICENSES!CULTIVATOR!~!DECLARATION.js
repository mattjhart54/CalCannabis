...
try{
	...
	if (decCapId){
		showMessage = true;
		cancel = true;
		comment("The following Final Affidavit and Declaration was already submitted for this application: " + decCapId + ". If you have questions please email licensing@cannabis.ca.gov or call 1-844-61-CA-DCC (1-844-612-2322).");
	}else{
