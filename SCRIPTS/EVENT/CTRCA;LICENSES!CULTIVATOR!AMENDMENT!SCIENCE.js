...
// Copy custom fields from the license record to the parent record
	...
	copyASITablesCDFA(parentId,capId,"DEFICIENCIES","DENIAL REASONS","OWNERS","CANNABIS FINANCIAL INTEREST","PREMISES ADDRESSES","SOURCE OF WATER SUPPLY","ELECTRICITY USAGE","AVERAGE WEIGHTED GGEI");
