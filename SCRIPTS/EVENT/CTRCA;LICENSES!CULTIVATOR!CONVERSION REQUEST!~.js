...
// Link Requested License(s) to Conversion Request Record as a child
	...
	logDebug("An error has occurred in CTRCA:LICENSES/CULTIVATOR/CONVERSION REQUEST/*: Force file date to be submission date: " + err.message);
	logDebug(err.stack);
	aa.sendMail(sysFromEmail, debugEmail, "", "An error has occurred in CTRCA:LICENSES/CULTIVATOR/CONVERSION REQUEST/*: Force file date to be submission date: "+ startDate, capId + br + err.message + br + err.stack + br + currEnv);
}
