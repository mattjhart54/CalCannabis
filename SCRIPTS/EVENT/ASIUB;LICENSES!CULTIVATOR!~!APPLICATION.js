...
try{
	...
	if(AInfo["Small Retail Water Supplier Review Status"] == "Complete") {
		...
		for(wssr in SOURCEOFWATERSUPPLY) {
			if(matches(SOURCEOFWATERSUPPLY[wssr]["Type of Water Supply"],"Small Retail Supplier Diversion","Small Retail Supplier - Delivery or Pickup from a Groundwater Well")) {
				wsRows = wsRows + 1;
			}
		}
