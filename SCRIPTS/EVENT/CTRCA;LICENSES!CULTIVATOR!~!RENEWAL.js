...
//  No fast track. Send renewal submitted email notification to DRP
	...
	try{
		var cType = "Renewal Required Documents";
		...
		logDebug("An error has occurred in CTRCA:LICENSES/CULTIVATOR/*/RENEWAL: Remove Conditions: " + err.message);
		logDebug(err.stack);
		aa.sendMail(sysFromEmail, debugEmail, "", "An error has occurred in CTRCA:LICENSES/CULTIVATOR/*/RENEWAL: Remove Conditions: "+ startDate, capId + br + err.message+ br+ err.stack + br + currEnv);
	}
