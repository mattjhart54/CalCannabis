		...
		if (taskName == "Conversion Review"){
			if(fTask.getActiveFlag()=="Y") {
				...
				if(assignedUserID!=null){
					...
					if(staffEmail){
						email(staffEmail, sysFromEmail, "A new document has been uploaded.", "A new document has been uploaded for record" + capIDString + ". Please review this new document before taking any action on the record.");
					}
				}
			}
		}
