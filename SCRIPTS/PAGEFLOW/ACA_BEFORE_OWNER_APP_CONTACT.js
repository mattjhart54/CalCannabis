...
//	comment("parent ID " + parentId + " app ID " + varAppNbr);
		...
		if(!ownerFnd) {
			showMessage = true;
			cancel = true;
			comment("Error:  Your user email " + currEmail + " does not match an owner " + ownEmail + " on the License Application " + varAppNbr  + " Contact the Designated Responsible Party for this application");
		}
